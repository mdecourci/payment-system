...
public sealed class PaymentException extends RuntimeException
    permits PaymentException.CardDeclined,
            PaymentException.InvalidCard,
            PaymentException.InsufficientFunds,
            PaymentException.CustomerInactive,
            PaymentException.NotFound,
            PaymentException.FraudBlocked,
            PaymentException.InvalidState,
            PaymentException.DuplicateEntry {
    ...
    public static final class InvalidCard extends PaymentException {
        public InvalidCard(String reason) { super("INVALID_CARD", reason); }
    }

    public static final class InsufficientFunds extends PaymentException {
        public InsufficientFunds(String reason) { super("INSUFFICIENT_FUNDS", reason); }
    }
    ...
    public static final class InvalidState extends PaymentException {
        public InvalidState(String reason) { super("INVALID_STATE", reason); }
    }

    public static final class DuplicateEntry extends PaymentException {
        public DuplicateEntry(String reason) { super("DUPLICATE", reason); }
    }
}
